const inputTempK = document.querySelector("#tempK") as HTMLInputElement
const inputTempC = document.querySelector("#tempC") as HTMLInputElement
const inputTempF = document.querySelector("#tempF") as HTMLInputElement
